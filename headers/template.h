...
char url_section[] = "<ul class='nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0'><li><a class='nav-link px-2 text-secondary' href='{{url}}'>{{title}}</a></li></ul></div></div></nav><main>";
...
char *section_pointers_input[SECTION_COUNT];
